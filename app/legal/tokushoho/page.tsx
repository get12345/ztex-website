                ...
                <div className="mt-10">
                    <dl className="divide-y divide-neutral-800 border-t border-neutral-800">
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">販売業者</dt>
                            <dd className="text-neutral-200 md:col-span-2">株式会社ZTEX</dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">所在地</dt>
                        ...
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">メールアドレス</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                                info@ztex-japan.com
                            </dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">販売価格</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                                各サービスページに記載、または個別お見積もりに準じます。
                            </dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">商品代金以外の必要料金</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                        ...
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">お支払い方法</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                                銀行振込、クレジットカード決済（Stripe等）
                            </dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">お支払い時期</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                                契約締結時、または請求書発行後翌月末払い（法人契約の場合）。
                            </dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">引渡し時期</dt>
                            <dd className="text-neutral-200 md:col-span-2">
                                契約締結後、直ちに（または契約で定めた期間内に）サービス提供を開始します。
                            </dd>
                        </div>
                        <div className="grid grid-cols-1 gap-4 py-6 md:grid-cols-3">
                            <dt className="font-medium text-neutral-300">返品・キャンセルについて</dt>
                            <dd className="text-neutral-200 md:col-span-2">
